    ...
    async function loadTheaterPublications() {
      try {
        const response = await fetch(
          `${API_BASE_URL}/api/publications/section/TEATRO`
        );
  ...
  return (
    <section className="publications-container theory-section" style={{ backgroundImage: `linear-gradient(rgba(10,6,4,0.55), rgba(10,6,4,0.55)), url(${banner80})`, backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" }}>
      <header className="theater-header">
        <h1 className="theater-page-title">
          <span className="theater-page-main">I &nbsp; S &nbsp; I &nbsp; D &nbsp; R &nbsp; O &nbsp; &nbsp; L &nbsp; U &nbsp; N &nbsp; A</span>
          <span className="theater-page-sub">Teatro</span>
        </h1>
        <div className="theater-page-rule" />
